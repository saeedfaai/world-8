# World 8 — Publication Work Queue

Status: ACTIVE
Owner: Saeed Farrokhi

## P0 — GitHub v0.1.0 + Zenodo — COMPLETE
- [x] freeze exact commit `b14f2feea0fa233851a774d6ebd295b63cde75c0`
- [x] run validators / release gate
- [x] publish GitHub development Pre-release `V0.1.0`
- [x] create matching Zenodo snapshot
- [x] Zenodo record https://zenodo.org/records/22127650
- [x] DOI https://doi.org/10.5281/zenodo.22127650
- [x] append DOI lineage without overwriting Z0-A / World 7 / World v6.2
- [x] synchronize Drive publication registries

## P1 — Hugging Face — COMPLETE UNDER VERIFIED USER ACCOUNT
- [x] verified account `Saeedfa`
- [x] create `world8-core`
- [x] create `world8-forecast-hall`
- [x] create `world8-market-data`
- [x] create public `World 8 Demo` Static Space
- [x] create World 8 Collection
...
See `docs/PUBLISHING_ARCHITECTURE.md` for the governing publication architecture.
